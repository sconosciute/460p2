...
* @apiBody {string} original title Name the book was first given
...
* @apiBody {string} image url The url of the image
* @apiBody {string} small image url The url of the small image of the book
*
*
*
...
*
* @apiDescription Deletes a single book or more from the database by ISBN, author and title containing
*
* @apiName DeleteBooks
* @apiGroup books
*
* @apiParam {String} author The name of the authors of the books you want to delete
* @apiParam {String} title containing  Titles of the books you want to delete
